...
internal class SPOSTerminalDisconnectContract : ActivityResultContract<SPOSTerminal, TerminalOperationStatus>() {
    ...
    override fun parseResult(resultCode: Int, intent: Intent?): TerminalOperationStatus =
        SPOSResponseHandler.handleTerminalDisconnectResponse(resultCode)
}