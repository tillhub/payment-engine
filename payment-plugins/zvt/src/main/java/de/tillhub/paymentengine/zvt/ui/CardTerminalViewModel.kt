...
import de.tillhub.paymentengine.zvt.helper.TerminalConfig
import de.tillhub.paymentengine.zvt.helper.TerminalConfigImpl
...
import de.tillhub.paymentengine.zvt.helper.ZvtResultCodes
    ...
    fun onError(moveToFront: () -> Unit) {
        ...
        viewModelScope.launch {
            ...
            _terminalOperationState.value = State.Error(
                ...
                rawData = lastData.orEmpty(),
                data = data,
                resultCode = ZvtResultCodes.getZVTCode(data?.resultCode)
            )
        }
    }
